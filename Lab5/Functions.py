...
def plotcurve(clf_hist, metrics='binary'):
    ...
    best_loss_epoch = np.argmin(clf_hist.history["val_loss"])
    best_loss_value = np.min(clf_hist.history["val_loss"])
    plt.plot(best_loss_epoch, best_loss_value, marker="x", color="r", label="best model")
    plt.xlabel("Epochs")
    ...
    if metrics == 'binary':
        ...
        best_accuracy_epoch = np.argmax(clf_hist.history["val_binary_accuracy"])
        best_accuracy_value = np.max(clf_hist.history["val_binary_accuracy"])
    else:
        ...
        best_accuracy_epoch = np.argmax(clf_hist.history["val_accuracy"])
        best_accuracy_value = np.max(clf_hist.history["val_accuracy"])
    plt.plot(best_accuracy_epoch, best_accuracy_value, marker="x", color="r", label="best model")
    plt.xlabel("Epochs")
    ...
    if 'dice_coefficient' in clf_hist.history and 'precision' in clf_hist.history and 'recall' in clf_hist.history:
        plt.plot(clf_hist.history["dice_coefficient"], label="Dice coefficient")
        plt.plot(clf_hist.history["precision"], label="Precision")
        plt.plot(clf_hist.history["recall"], label="Recall")
        best_dice_epoch = np.argmax(clf_hist.history["dice_coefficient"])
        best_dice_value = np.max(clf_hist.history["dice_coefficient"])
        plt.plot(best_dice_epoch, best_dice_value, marker="x", color="r", label="best model")
        plt.xlabel("Epochs")
